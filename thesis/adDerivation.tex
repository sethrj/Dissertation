...
\end{equation}
Here, $\vec{F}$ is the first angular moment of the \emph{interior} solution,
the interior radiation flux.
...
\end{equation*}
Now we neglect the high-order $O(\epsilon^2)$ terms to obtain the
following approximate transport equation:
\begin{equation*}
...
have any extraneous source term:
