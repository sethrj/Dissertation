...
\end{equation*}
In 1-D, 2-D, and 3-D, this evaluates to
\begin{equation*}
4 F^{-}
...
Effectively, everywhere with a $4\pi$ factor is replaced with $\omega_0$, which
(see Table~\ref{tab:angularMoments}) is $4\pi$ in 3-D space but is $2\pi$ in
flatland geometry.
