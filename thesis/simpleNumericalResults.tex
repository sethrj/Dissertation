...
None of the low-order methods consistently matches the transport solution at
all times. As the problem tends toward steady-state, however, the anisotropic
...
channel problems analyzed earlier: diffusion fails in these problems.
