...
\begin{figure}[htb]
  \centering\small
  \subfloat[$\Delta_t=0.02$]{\hspace{-.1in}\input{ap1-blastpipe/002-phi-center/plot}\hspace{-.1in}}%
  \subfloat[$\Delta_t=0.05$]{\hspace{-.1in}\input{ap1-blastpipe/005-phi-center/plot}\hspace{-.1in}}
  
  \subfloat[$\Delta_t=0.10$]{\hspace{-.1in}\input{ap1-blastpipe/010-phi-center/plot}\hspace{-.1in}}%
  \subfloat[$\Delta_t=0.20$]{\hspace{-.1in}\input{ap1-blastpipe/020-phi-center/plot}\hspace{-.1in}}
  
  \subfloat[$\Delta_t=0.50$]{\hspace{-.1in}\input{ap1-blastpipe/050-phi-center/plot}\hspace{-.1in}}%
  \subfloat[$\Delta_t=1.00$]{\hspace{-.1in}\input{ap1-blastpipe/100-phi-center/plot}\hspace{-.1in}}
