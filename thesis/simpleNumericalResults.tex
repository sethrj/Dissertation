...
\\ \bottomrule
  ...
  single-channel problem.}{
      Here, $\sigma_c$ and $\sigma_d$ are the total opacity in the diffusive
      and voided region, respectively; and $W$ is the half-width of the channel.
...
\begin{figure}[htb]
  ...
  \Caption{Problem description for the blast wave problem.}{
...
The isotropic initial condition primarily TODO
