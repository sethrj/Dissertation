...
As represented in Fig.~\ref{fig:crashaltMaterials}, the problem consists of:
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Flatland crooked pipe}

The ``tophat'' or ``crooked pipe'' problem \cite{Gen2001} is of practical
interest in the strategic astrophysics community. 
...
\cite{Kno2007}), contains two square obstacles that impede a front of
...
at $(3/16, 3/16)$ and $(19/16, 3/16)$ (Fig.~\ref{fig:easymkMaterials}).
...
A second problem from \cite{Mou2006} has steeper spatial gradients and
...
obstacles. In Fig.~\ref{fig:hardmkPseudocolor}, this is seen in the FLD method
...
to represent the behavior of the radiation more accurately. Diffusion 
...
is cold, diffusive. Thus, in this realistic gray problem, diffusion a very
...
picture of the behavior of the anisotropic diffusion methods.
...
Other problems are less amenable to solution with the anisotropic diffusion
methods. 
