...
the ``crooked pipe'' problem seen in Ref.~\cite{Gen2001}.
...
The ``easy'' obstacle problem, described in Ref.~\cite{Mou2006} (and also used in
...
THIS ISN'T WORKING: I CANNOT EXPLAIN IT.
