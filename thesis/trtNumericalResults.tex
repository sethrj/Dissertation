...
We now extend our testing to 2-D.

\subsection{Problem description}

The second problem we run is a ``flatland'' problem similar to the
1-D problem. As represented in Fig.~\ref{fig:crashaltMaterials}, it consists of:
\begin{itemize}
  ...
  \item a channel region with $\sigma = T^{-3}$ and $c_v=1.0$; and
