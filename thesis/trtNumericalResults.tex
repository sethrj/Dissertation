...
FLAD- and AD-calculated wavefront positions different, demonstrating that only
during the initial transient is the flux limiter used.
...
One might argue that the previous problem is particularly suited to the
...
A second problem from \cite{Mou2006} has steeper spatial gradients and very
large streaming regions: it should therefore be outside the comfort zone of
