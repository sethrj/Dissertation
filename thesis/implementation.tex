...
Cartesian mesh, where all cells are quadrilaterals, and each cell connects (in
...
Figure~\ref{fig:cellDiagram} represents a single cell $i,j$ with width
$\Delta_{x,i}$ and height $\Delta_{y,j}$. For finite difference methods, 
